# Welcome to your WebSharp Electron Application - texteditor
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- texteditor-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- texteditor.js                    // javascript code implementation
     |--- DialogHelpers
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- DialogHelpers_macosx.csproj    // MacOSX project  
          |--- DialogHelpers.cs               // Application Implementation
          |--- DialogHelpers.csproj           // Windows project          
...
* `src/texteditor.js` - this src file defines calls the DialogHelpers C# expression that will be printed to the console by default.
* `src/DialogHelpers/DialogHelpers.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

# Welcome to your WebSharp Electron Application - contextmenu
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- contextmenu-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- contextmenu.js                    // javascript code implementation
     |--- ContextMenuRenderer
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- ContextMenuRenderer_macosx.csproj    // MacOSX project  
          |--- ContextMenuRenderer.cs               // Application Implementation
          |--- ContextMenuRenderer.csproj           // Windows project          
...
* `src/contextmenu.js` - this src file defines calls the ContextMenuRenderer C# expression that will be printed to the console by default.
* `src/ContextMenuRenderer/ContextMenuRenderer.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

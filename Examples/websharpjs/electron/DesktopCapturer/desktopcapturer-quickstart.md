# Welcome to your WebSharp Electron Application - desktopcapturer
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- desktopcaptuer-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- desktopcapturer.js                    // javascript code implementation
     |--- Main                             
          |--- nuget.config                 // Configuring NuGet behavior
          |--- packages.config              // Used to track installed packages
          |--- MainWindow_macosx.csproj     // MacOSX project  
     ...
     |--- Capture
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- Capture_macosx.csproj    // MacOSX project  
          |--- Capture.cs               // Application Implementation
          |--- Capture.csproj           // Windows project          
...
* `src/desktopcaptuer.js` - this src file defines calls the Capture C# expression that will be printed to the console by default.
* `src/Capture/Capture.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

# Welcome to your WebSharp Electron Application - clipboard
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- clipboard-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- clipboard.js                    // javascript code implementation
     |--- Clipper
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- Clipper_macosx.csproj    // MacOSX project  
          |--- Clipper.cs               // Application Implementation
          |--- Clipper.csproj           // Windows project          
...
* `src/clipboard.js` - this src file defines calls the Clipper C# expression that will be printed to the console by default.
* `src/Clipper/Clipper.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

# Welcome to your WebSharp Electron Application - mainbrowserwindow
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- mainbrowserwindow-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- mainbrowserwindow.js                    // javascript code implementation
     |--- MainWindow
          ...
          |--- MainWindow.cs               // Application Implementation
...
* `src/mainbrowserwindow.js` - this src file defines calls the MainWindow C# expression that will be printed to the console by default.
* `src/MainWindow/MainWindow.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

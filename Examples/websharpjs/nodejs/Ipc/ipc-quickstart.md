# Welcome to your WebSharp Electron Application - ipc
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- ipc-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- ipc.js                    // javascript code implementation
     |--- Ping
...
* `src/ipc.js` - this src file defines calls the Ping C# expression that will be printed to the console by default.

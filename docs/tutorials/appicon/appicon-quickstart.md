# Welcome to your WebSharp Electron Application - appicon
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- appicon-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- appicon.js                    // javascript code implementation
     |--- Main                             
     ...
     |--- Iconic
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- Iconic_macosx.csproj    // MacOSX project  
          |--- Iconic.cs               // Application Implementation
          |--- Iconic.csproj           // Windows project          
...
* `src/appicon.js` - this src file defines calls the Iconic C# expression that will be printed to the console by default.
* `src/Iconic/Iconic.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

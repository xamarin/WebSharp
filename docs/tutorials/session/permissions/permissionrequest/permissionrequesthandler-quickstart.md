# Welcome to your WebSharp Electron Application - permissionrequesthandler
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- permissionrequesthandler-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- permissionrequesthandler.js                    // javascript code implementation
     |--- Main                             
     ...
     |--- Request
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- Request_macosx.csproj    // MacOSX project  
          |--- Request.cs               // Application Implementation
          |--- Request.csproj           // Windows project          
...
* `src/permissionrequesthandler.js` - this src file defines calls the Request C# expression that will be printed to the console by default.
* `src/Request/Request.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

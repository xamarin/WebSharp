# Welcome to your WebSharp Electron Application - printtopdf
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- printtopdf-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- printtopdf.js                    // javascript code implementation
     |--- Main                             
     ...
     |--- PdfRenderer
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- PdfRenderer_macosx.csproj    // MacOSX project  
          |--- PdfRenderer.cs               // Application Implementation
          |--- PdfRenderer.csproj           // Windows project          
...
* `src/printtopdf.js` - this src file defines calls the PdfRenderer C# expression that will be printed to the console by default.
* `src/PdfRenderer/PdfRenderer.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

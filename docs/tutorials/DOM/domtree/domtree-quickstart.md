# Welcome to your WebSharp Electron Application - domtree
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- domtree-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- domtree.js                    // javascript code implementation
     |--- Main                             
     ...
     |--- DOMInfo
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- DOMInfo_macosx.csproj    // MacOSX project  
          |--- DOMInfo.cs               // Application Implementation
          |--- DOMInfo.csproj           // Windows project          
...
* `src/domtree.js` - this src file defines calls the DOMInfo C# expression that will be printed to the console by default.
* `src/DOMInfo/DOMInfo.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

# Welcome to your WebSharp Electron Application - browserinformation
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- browserinformation-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- browserinformation.js                    // javascript code implementation
     |--- Main                             
     ...
     |--- Information
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- Information_macosx.csproj    // MacOSX project  
          |--- Information.cs               // Application Implementation
          |--- Information.csproj           // Windows project          
...
* `src/browserinformation.js` - this src file defines calls the Information C# expression that will be printed to the console by default.
* `src/Information/Information.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.

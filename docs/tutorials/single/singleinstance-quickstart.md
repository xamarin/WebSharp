# Welcome to your WebSharp Electron Application - singleinstance
...
|--- .vscode                           // VS Code integration
     ...
     |--- settings.json
|--- .vscodeignore
|--- singleinstance-quickstart.md        // The document you are reading now
...
|--- src                              // sources
     |--- singleinstance.js                    // javascript code implementation
     |--- Main                             
     ...
     |--- Single
          |--- nuget.config           // Configuring NuGet behavior
          |--- packages.config        // Used to track installed packages
          |--- Single_macosx.csproj    // MacOSX project  
          |--- Single.cs               // Application Implementation
          |--- Single.csproj           // Windows project          
...
* `src/singleinstance.js` - this src file defines calls the Single C# expression that will be printed to the console by default.
* `src/Single/Single.cs` - this src file is the C# managed code implementation of the application that prints to the console by default.
